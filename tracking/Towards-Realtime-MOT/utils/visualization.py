...
def plot_tracking(image, tlwhs, obj_ids, scores=None, frame_id=0, fps=0., ids2=None):
    ...
    for i, tlwh in enumerate(tlwhs):
        ...
        cv2.rectangle(im, intbox[0:2], intbox[2:4], color=color, thickness=line_thickness+3)
        cv2.putText(im, id_text, (intbox[0], int((intbox[1] + intbox[3])/2)), cv2.FONT_HERSHEY_PLAIN, text_scale+4, (0, 0, 255),
