...
class MobileNetV2_fpn7(nn.Module):
    def __init__(self, width_mult=1.0, inverted_residual_setting=None):
        super(MobileNetV2_fpn7, self).__init__()
...
@registry.BACKBONES.register('mobilenet_v2_fpn7')
def mobilenet_v2_fpn7(cfg, pretrained=True):
    model = MobileNetV2_fpn7()
    if pretrained:
