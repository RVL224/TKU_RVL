...
class MobileNetV2_fpn_test(nn.Module):
    def __init__(self, width_mult=1.0, inverted_residual_setting=None):
        super(MobileNetV2_fpn_test, self).__init__()
        ...
        self.smooth4 = InvertedResidual(256, 256, 1, 1)
        self.smooth3 = InvertedResidual(256, 256, 1, 1)
        self.smooth2 = InvertedResidual(256, 256, 1, 1)
        self.smooth1 = InvertedResidual(256, 256, 1, 1)
        self.smooth0 = InvertedResidual(256, 256, 1, 1)
...
@registry.BACKBONES.register('mobilenet_v2_fpn_test')
def mobilenet_v2_fpn_test(cfg, pretrained=True):
    model = MobileNetV2_fpn_test()
    if pretrained:
