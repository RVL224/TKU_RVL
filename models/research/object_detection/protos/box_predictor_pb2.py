...
_CONVOLUTIONALBOXPREDICTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reduce_last_predict_layer', full_name='object_detection.protos.ConvolutionalBoxPredictor.reduce_last_predict_layer', index=12,
