...
# pytorch ssdlite mobilenet v2 rfb anchor 3 
import sys
...
from object_detection.models import feature_map_generators_custom_for_v9 as feature_map_generators
...
class SSDMobileNetV2CustomV9FeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSDMobileNetV2CustomV9FeatureExtractor, self).__init__(
  ...
  def extract_features(self, preprocessed_inputs):
    ...
    feature_map_layout = {
        ...
        'layer_depth':[-1, -1, -1, 512, 256, 256][:self._num_layers],
      ...
      with slim.arg_scope(
        ...
        with slim.arg_scope(self._conv_hyperparams_fn()):
          with (slim.arg_scope([slim.conv2d, slim.separable_conv2d],
            ...
            with tf.variable_scope('rfb', reuse=self._reuse_weights):
              rfb_features = feature_map_generators.rfb_feature_maps(
                [(key, fpn_features[key]) for key in feature_rfb_blocks],
                depth=depth_fn(additional_layer_depth))
        
    fpn_features[feature_rfb_blocks[0]] = rfb_features['rfb_'+feature_rfb_blocks[0]]
    # fpn_features[feature_rfb_blocks[1]] = rfb_features['rfb_'+feature_rfb_blocks[1]]
