...
class SSDMobileNetV2CustomV11TestFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSDMobileNetV2CustomV11TestFeatureExtractor, self).__init__(
