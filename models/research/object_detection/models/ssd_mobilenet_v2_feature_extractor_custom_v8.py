...
# pytorch ssdlite mobilenet_v2_fpn7
import sys
...
class SSDMobileNetV2CustomV8FeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSDMobileNetV2CustomV8FeatureExtractor, self).__init__(
