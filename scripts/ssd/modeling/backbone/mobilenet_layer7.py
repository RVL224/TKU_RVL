...
class MobileNetV2_layer7(nn.Module):
    def __init__(self, width_mult=1.0, inverted_residual_setting=None):
        super(MobileNetV2_layer7, self).__init__()
...
@registry.BACKBONES.register('mobilenet_v2_layer7')
def mobilenet_v2_layer7(cfg, pretrained=False):
    model = MobileNetV2_layer7()
#     if pretrained:
