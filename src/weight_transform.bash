...
--config-file '/tf/minda/github/TKU_RVL/save_models/pytorch/pytorch_model/ssdlite_mobilenet_fpn6_mixconv_512/mobilenet_fpn6_mixconv_512_bdd100k+TKU+CREDA+MOT17+taipei_E200-Copy1.yaml' \
